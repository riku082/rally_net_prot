    ...
    <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-4 sm:p-6">
      ...
      {selectedCard && (
        <div className="fixed inset-0 bg-gray-100/80 backdrop-blur-sm flex items-center justify-center z-50 p-2">
          <div className="bg-white rounded-xl shadow-2xl border border-gray-200 w-auto">
            ...
            <div className="p-3 max-h-[calc(100vh-120px)] overflow-y-auto space-y-2 w-auto max-w-xl">
              {/* カード基本情報 */}
              <div>
                <h4 className="text-base font-bold text-gray-900 mb-1">{selectedCard.title}</h4>
                <div className="flex flex-wrap items-center gap-2 mb-1">
                  <span className={`px-1.5 py-0.5 rounded-full text-[10px] font-medium ${difficultyColors[selectedCard.difficulty]}`}>
                ...
                <p className="text-xs text-gray-700 mb-2">{selectedCard.description}</p>
              </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-2">
                  ...
                  <div className="flex flex-col lg:flex-row gap-2">
                    ...
                    {selectedCard.visualInfo.shotTrajectories && selectedCard.visualInfo.shotTrajectories.length > 0 && (
                      <div className="flex-1">
                        <h6 className="text-[10px] font-medium text-gray-600 mb-1">ショット詳細</h6>
                        <div className="space-y-0.5 max-h-[150px] lg:max-h-[350px] overflow-y-auto">
