...
import { FaTachometerAlt, FaUser, FaChartBar, FaUserCircle, FaRss, FaUserFriends, FaBrain, FaBook, FaMailBulk } from 'react-icons/fa';
...
const navItems = [
  ...
  { label: '目安箱', icon: <FaMailBulk />, path: '/feedback', badge: '限定公開' },
];
